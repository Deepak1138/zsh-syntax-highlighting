...
```zsh
git clone https://github.com/Deepak1138/zsh-syntax-highlighting.git
...
```
https://github.com/Deepak1138/zsh-syntax-highlighting/archive/master.tar.gz
```
...
#### [Antigen](https://github.com/Deepak1138/antigen)

Add `antigen bundle zsh-users/zsh-syntax-highlighting` as the last bundle in
your `.zshrc`.

#### [Oh-my-zsh](https://github.com/Deepak1138/ohmyzsh)

1. Clone this repository in oh-my-zsh's plugins directory:

    ```zsh
    git clone https://github.com/Deepak1138/zsh-syntax-highlighting.git ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/plugins/zsh-syntax-highlighting
    ```
...
Add `zgen load Deepak1138/zsh-syntax-highlighting` to the end of your `.zshrc`.

#### [zplug](https://github.com/zplug/zplug)

Add `zplug "Deepak1138/zsh-syntax-highlighting", defer:2` to your `.zshrc`.

#### [zplugin](https://github.com/psprint/zplugin)

Add `zplugin load Deepak1138/zsh-syntax-highlighting` to the end of your
`.zshrc`.
